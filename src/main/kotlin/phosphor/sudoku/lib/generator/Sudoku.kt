...
package phosphor.sudoku.lib.generator
...
import phosphor.sudoku.lib.solver.Solver

import kotlin.random.Random

class Sudoku(private val level: Level){
    ...
    private fun isSafeToPutIn(row: Int, column: Int, digit: Int) = isUnusedInBox(findBoxStart(row), findBoxStart(column), digit)
